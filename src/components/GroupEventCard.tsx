  ...
  return (
    ...
    >
      ...
      <div className="w-[60%] h-[100%] flex flex-col justify-between p-3 pl-8 pt-3">
        <div>
          <p className="text-[11px] text-[#2C3E50] font-medium">
            {formattedDate}
          </p>
          <h2 className="text-[17px] font-bold text-[#2C3E50] mt-1">{title}</h2>
          <p className="text-[10px] font-semibold text-textPrimary mt-2 pr-4">
            {filteredDescription}
          </p>
        </div>
        <div className="flex w-[100%] h-[25%] mt-auto items-end">
