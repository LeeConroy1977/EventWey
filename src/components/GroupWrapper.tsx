    ...
    <div className="w-[100%] h-[21rem] flex items-center justify-center  bg-bgPrimary border-b-2 border-gray-200 p-8  ">
      <div className=" w-[76%] h-[100%] flex items-center justify-center  mt-6 ">
        ...
        <div className="w-[50%] h-[100%] flex flex-col items-center justify-start pl-16 p-4">
          ...
          <p className="text-textPrimary text-[14px] font-semibold mt-4 mr-auto ">
            {openAccess ? "Public" : "Private"} Group
          </p>
          <p className="text-[14px] font-semibold mt-4 mr-auto text-primary">
            {description[0]}
          </p>
          <div className="flex items-center mt-8 mr-auto ">
