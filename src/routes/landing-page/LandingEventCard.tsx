...
const LandingEventCard = ({ event, handleClick }) => {
  ...
  return (
    <div
      className="w-[23.5%] h-[350px] flex flex-col bg-bgPrimary rounded-lg cursor-pointer border-[1px] border-gray-200"
      ...
      {event && (
        <>
          <img
            src={image}
            alt=""
            className="w-[100%] h-[160px] rounded-tl-lg rounded-tr-lg"
          />
          <div className="w-[100%] h-[56%] flex flex-col p-3 py-4">
            ...
            <p className="text-[9px] font-semibold text-textPrimary mt-3">
