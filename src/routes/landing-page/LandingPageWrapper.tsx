...
const LandingPageWrapper = () => {
  ...
  return (
    <div className="w:full tablet:w-[86%]  desktop:w-[76%] tablet:h-[22rem] xl-screen:h-[25rem]  flex flex-col tablet:flex-row items-center justify-start tablet:justify-center  bg-bgPrimary px-6 tablet:px-0 tablet:mt-6 desktop:mt-14">
      <div className="w-full tablet:w-[60%] tablet:h-[100%] flex flex-col items-center justify-center desktop:p-0">
        <h1 className="w-[100%] text-textPrimary text-[18px] tablet:text-[22px]  desktop:text-[30px] xl-screen:text-[34px] font-bold mt-8 tablet:mt-2 desktop:mr-auto">
        ...
        <p className="text-[14px] tablet:text-[13px] desktop:text-[16px] xl-screen:text-[18px]   text-textPrimary font-medium mt-8 tablet:mt-3 desktop:mt-4   w-full tablet:w-[90%] desktop:w-[80%] tablet:mr-auto">
